...
ClapTrap::ClapTrap(void): name("ClapTrap"), type("ClapTrap"), hitPoints(100), maxhitPoints(100), energyPoints(100), maxEnergyPoints(100),
    ...
    std::cout << this->type << " " << this->name << " -- start bootup sequence(default ClapTrap)" << std::endl;
}
...
bool ClapTrap::rangedAttack(std::string const & target) {
    ...
    << "with a rangedAttack attack causing " << this->rangedAttackDamage <<  " points of damage ! " << std::endl;
    return true;
}

bool ClapTrap::meleeAttack(std::string const & target) {
        std::cout << this->type << " " << this->name << " attacks " << target
    << "with a meleeattack causing " << this->meleeAttackDamage <<  " points of damage ! " << std::endl;
    return true;
}
...
ClapTrap::~ClapTrap(void) {
    std::cout << this->type << " " << this->name << " is dead(Default claptrap destructor)" << std::endl;
}
